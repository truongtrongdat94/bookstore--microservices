...
app.get('/', (req: Request, res: Response) => {
  res.json({
    ...
    endpoints: {
      books: {
        list: 'GET /books',
        search: 'GET /books?search=keyword',
        filter: 'GET /books?category=1&minPrice=10&maxPrice=50',
        detail: 'GET /books/:id',
        bestsellers: 'GET /books/bestsellers',
        reviews: 'GET /books/:id/reviews',
        addReview: 'POST /books/:id/reviews'
      },
      categories: {
        list: 'GET /categories',
