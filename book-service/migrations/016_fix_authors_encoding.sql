...
-- Re-insert authors with proper UTF-8 encoding
...
('Arthur Schopenhauer', 'Đức', 1788, 1860,
 'Arthur Schopenhauer (1788-1860) là triết gia người Đức, nổi tiếng với tác phẩm "Thế giới như ý chí và biểu tượng". Ông được coi là một trong những triết gia bi quan nhất trong lịch sử triết học phương Tây.

Sinh ra tại Danzig (nay là Gdańsk, Ba Lan), Schopenhauer đã phát triển một hệ thống triết học độc đáo, kết hợp giữa triết học phương Tây và tư tưởng phương Đông, đặc biệt là Phật giáo và Ấn Độ giáo.

Tư tưởng của ông đã ảnh hưởng sâu sắc đến nhiều nhà tư tưởng và nghệ sĩ sau này, bao gồm Nietzsche, Wagner, Freud và nhiều người khác.',
...
('Agatha Christie', 'Anh', 1890, 1976,
 'Agatha Christie (1890-1976) là nữ nhà văn trinh thám người Anh, được mệnh danh là "Nữ hoàng trinh thám". Bà là một trong những tác giả bán chạy nhất mọi thời đại với hơn 2 tỷ bản sách được bán ra.

Bà đã sáng tạo ra hai nhân vật thám tử nổi tiếng: Hercule Poirot và Miss Marple. Các tác phẩm của bà nổi tiếng với những cốt truyện phức tạp và những cú twist bất ngờ.

Một số tác phẩm nổi tiếng nhất bao gồm "Murder on the Orient Express", "And Then There Were None", và "The Murder of Roger Ackroyd". Vở kịch "The Mousetrap" của bà là vở kịch được diễn liên tục lâu nhất trong lịch sử.',
 'Một manh mối là một manh mối, và một sự thật là một sự thật.',
 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=600',
 NULL),

('Alan Moore', 'Anh', 1953, NULL,
 'Alan Moore là nhà văn truyện tranh người Anh, được coi là một trong những người viết truyện tranh vĩ đại nhất mọi thời đại. Sinh năm 1953 tại Northampton, ông đã cách mạng hóa ngành công nghiệp truyện tranh với những tác phẩm đầy tính nghệ thuật và triết học.

Các tác phẩm nổi tiếng của ông bao gồm "Watchmen", "V for Vendetta" và "From Hell". Những tác phẩm này đã nâng tầm truyện tranh lên thành một hình thức nghệ thuật được công nhận.

Moore nổi tiếng với phong cách viết phức tạp, đa tầng và những chủ đề sâu sắc về chính trị, xã hội và bản chất con người.',
