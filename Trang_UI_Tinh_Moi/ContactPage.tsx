        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-gray-200 rounded-lg p-6 md:p-8">
              <h2 className="text-[#1B5E20] mb-6">Gửi tin nhắn cho chúng tôi</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto bg-[#1B5E20] text-white px-8 py-3 rounded-lg hover:bg-[#145016] transition-colors"
                >
                  Gửi tin nhắn
                </button>
              </form>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-[#1B5E20] mb-4">Trụ sở chính</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-gray-400 shrink-0 mt-0.5" />
                  <div>
                    <p className="text-gray-700">59 Đỗ Quang, Trung Hoà</p>
                    <p className="text-gray-700">Cầu Giấy, Hà Nội</p>
                  </div>
                </div>
                
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-gray-400 shrink-0" />
                  <p className="text-gray-700">024 3512 3456</p>
                </div>
                
                <div className="flex items-center gap-3">
                  <Mail className="w-5 h-5 text-gray-400 shrink-0" />
                  <p className="text-gray-700">contact@nhanam.vn</p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Thứ 7: 9:00 - 12:00</p>
            ...
            <div className="bg-[#1B5E20] text-white p-6 rounded-lg">
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-white/80 text-sm mb-1">Hotline:</p>
                ...
                <div className="pt-3 border-t border-white/20">
                  <p className="text-white/80 text-sm">Thời gian hỗ trợ:</p>
                  <p className="text-sm">8:00 - 21:00 (Thứ 2 - CN)</p>
                </div>
              </div>
            </div>
            ...
            {/* Social Media */}
            <div className="bg-gray-50 p-6 rounded-lg">
              <h4 className="text-[#1B5E20] mb-4">Kết nối với chúng tôi</h4>
              <div className="space-y-3">
            ...
            {/* FAQ */}
            <div className="bg-gray-50 p-6 rounded-lg">
              <h4 className="text-[#1B5E20] mb-3">Câu hỏi thường gặp</h4>
              <p className="text-sm text-gray-700 mb-3">
                Xem các câu hỏi thường gặp trước khi liên hệ
              </p>
